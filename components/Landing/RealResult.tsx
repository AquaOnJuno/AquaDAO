const RealResult = () => {
  return (
    <div className="flex flex-col xl:flex-row w-full mt-14 px-4 xl:px-8">
      <div className="w-full xl:w-[396px] flex bg-red justify-end">
        <img src="/real_result.png" alt="to be changed" className="w-full"/>
      </div>
      <div className="w-full ml-0 xl:ml-10 flex flex-col justify-center">
        <span className="text-3xl xl:text-4xl text-secondary font-bold" >
          Real Results<br />
        </span>
        <span className="text-3xl xl:text-4xl text-primary font-bold" >
          Measurable Impact.<br />
        </span>
        <span className="text-xl xl:text-2xl text-secondary font-bold">
          <br/>
